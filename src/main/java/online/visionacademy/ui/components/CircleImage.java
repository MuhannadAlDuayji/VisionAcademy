...
public class CircleImage extends JComponent {
    ...
    public CircleImage(String path) throws MalformedURLException {
        this(path, 0, null);
    }

    public CircleImage(String path, int borderSize, Color borderColor) throws MalformedURLException {
    ...
    protected final ImageIcon createImageIcon(String path, String description) throws MalformedURLException {
        URL imgURL = Paths.get(path).toUri().toURL();
        if (imgURL != null) {
